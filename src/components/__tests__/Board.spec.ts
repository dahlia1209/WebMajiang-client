...
describe("Board", () => {
  ...
  it("renders properly", async () => {
    ...
    wrapper = mount(BoardView, {
      props: {
        board: new Board(
          GameContentFormat.create({ action: "dapai", turn: "main" }),
  ...
  it("zimo and dapai", async () => {
    ...
    wrapper = mount(BoardView, {
      props: {
        board: new Board(GameContentFormat.create(), new Score({ zhuangfeng: "南", menfeng: "西", baopai: [new Pai("z", 7)] }), [
    ...
    gameStore.game = GameContentFormat.create({ action: "dapai", turn: "main",dapai:Pai.deserialize("z1"),dapaiIdx:99});
    await flushPromises();
    ...
    //下家ツモ
    gameStore.$state.game = GameContentFormat.create({
      action: "zimo",
      turn: "xiajia",
      // status: "thinking",
      zimopai: new Pai("b", 0),
    ...
    gameStore.game = GameContentFormat.create({ action: "dapai", turn: "xiajia",dapai:Pai.deserialize("z2"),dapaiIdx:0 });
    await flushPromises();
    ...
    gameStore.game = GameContentFormat.create({ action: "dapai", turn: "duimian",dapai:Pai.deserialize("z3"),dapaiIdx:0 });
    await flushPromises();
    ...
    //上家打牌
    gameStore.$state.game = GameContentFormat.create({ action: "dapai", turn: "shangjia",dapai:Pai.deserialize("z4") ,dapaiIdx:0 });
    await flushPromises();
  ...
  it("chi", async () => {
    ...
    board=new Board(new GameContentFormat(), score, [shoupai])
    wrapper = mount(BoardView, {props: {board: board,}});

    //上家ツモ
    gameStore.game = GameContentFormat.create({action: "zimo",turn: "shangjia",zimopai: new Pai("b", 0),});
    await flushPromises();
    expect(wrapper.findComponent(".shangjia-shoupai").find(".bingpai").findAll("img").length).toBe(14);
    //上家打牌
    gameStore.game = GameContentFormat.create({ action: "dapai", turn: "shangjia",dapai:Pai.deserialize("m1"),dapaiIdx:99});
    await flushPromises();
    ...
    console.log("chi",shoupai.getFulouCandidates("chi",Pai.deserialize("m1")))
    ...
    gameStore.$state.game = GameContentFormat.create({ action: "fulou", turn: "main", fulou });
    await flushPromises();
    expect(wrapper.findComponent(".shangjia-shoupai").find(".bingpai").findAll("img").length).toBe(13);
    ...
    gameStore.game = GameContentFormat.create({ action: "dapai", turn: "main",dapai:Pai.deserialize("m9"),dapaiIdx:10});
    await flushPromises();
    ...
    //下家打牌
    gameStore.game = GameContentFormat.create({ action: "dapai", turn: "xiajia",dapai:new Pai("p", 1),dapaiIdx:0});
    await flushPromises();
    ...
    gameStore.game = GameContentFormat.create({ action: "fulou", turn: "duimian", fulou });
    await flushPromises();
    expect(wrapper.findComponent(".main-shoupai").find(".bingpai").findAll("img").length).toBe(10);
    expect(wrapper.findComponent(".xiajia-shoupai").find(".bingpai").findAll("img").length).toBe(10);
    ...
    //対面打牌
    gameStore.$state.game = GameContentFormat.create({ action: "dapai", turn: "duimian",dapai: new Pai("s", 1),dapaiIdx:0 });
    await flushPromises();
    expect(wrapper.findComponent(".main-he").findAllComponents("img").length).toBe(0);
    expect(wrapper.findComponent(".xiajia-he").findAllComponents("img").length).toBe(0);
    expect(wrapper.findComponent(".duimian-he").findAllComponents("img").length).toBe(1);
    ...
    gameStore.$state.game = GameContentFormat.create({ action: "fulou", turn: "shangjia", fulou });
    await flushPromises();
    expect(wrapper.findComponent(".main-shoupai").find(".bingpai").findAll("img").length).toBe(10);
    expect(wrapper.findComponent(".xiajia-shoupai").find(".bingpai").findAll("img").length).toBe(10);
    ...
    //上家打牌
    gameStore.$state.game = GameContentFormat.create({ action: "dapai", turn: "shangjia",dapai: new Pai("z", 1),dapaiIdx:0 });
    await flushPromises();
    expect(wrapper.findComponent(".main-he").findAllComponents("img").length).toBe(0);
    expect(wrapper.findComponent(".xiajia-he").findAllComponents("img").length).toBe(0);
    expect(wrapper.findComponent(".duimian-he").findAllComponents("img").length).toBe(0);
